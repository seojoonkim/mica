  ...
  return (
    <div>
      <PageHeader lang={lang}
        eyebrow={dict.evidenceCell.eyebrow}
      ...
      >
        <DemoDisclosure lang={lang} detail="Demo fixture evidence, not official evidence. Every figure below is generated for interface development, carries no evidentiary weight, and no system on this page has been ranked by MICA." />
      </PageHeader>
        ...
        <DataList
          items={[
            { term: "Cell id", detail: id },
            {
              term: "System",
              detail: (
                <LocaleLink lang={lang} href={`/agents/${cell.system}`} className="mica-link">
            ...
            },
            {
              term: "Market",
              detail: (
                <LocaleLink lang={lang} href={`/countries/${cell.country}`} className="mica-link">
      ...
      >
        ...
        <DataTableScroller lang={lang} label={`Run cell ${id} — recorded values`}>
      ...
      <nav aria-label="Related run cells" className="mt-14">
        ...
        <ul className="mt-2 flex list-none flex-wrap gap-x-6 gap-y-1 p-0 text-[13.5px]">
          {siblings.map((other) => (
            <li key={runCellId(other)}>
              <LocaleLink lang={lang} href={evidenceHref(other)} className="mica-link">
        ...
        <p className="mt-4">
          <LocaleLink lang={lang} href="/evidence" className="mica-link">
            All run cells →
          </LocaleLink>
        </p>
      </nav>
