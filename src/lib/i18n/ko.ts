...
export const ko = {
  ...
  coverage: {
    headline: "평가 계열 10개 · 게시된 결과 계열 0개",
    detail:
      "MICA의 평가 분류 체계는 10개의 과제 계열을 정의합니다. 그중 결과가 게시된 계열은 하나도 없습니다. 아직 어떤 시스템도 측정·검증되지 않았기 때문입니다. 아래의 모든 계열은 무엇을 측정할 것인지에 대한 정의이지, 무엇을 측정했는지에 대한 보고가 아닙니다. 없는 결과는 없다고 밝히며, 0으로 표시하지 않습니다.",
    evaluationFamiliesTerm: "평가 계열",
    publishedFamiliesTerm: "게시된 결과 계열",
    measuredBadge: "결과 게시됨",
  ...
  home: {
    ...
    statMarkets: "시장",
    statFamilies: "과제 계열",
    statPublished: "게시된 결과 계열",
    statSystems: "검증된 시스템",
    statRuns: "측정된 실행",
    countedNote: "빌드 시점에 정본 레코드에서 직접 센 값입니다.",
    stackEyebrow: "측정 단위는 모델이 아니라 시스템입니다",
    bandEyebrow: "다섯 개 시장 에디션",
    disclosureDetail:
      "MICA는 아직 구축 중입니다. 아래 인터페이스는 완성되어 있지만, 그 뒤의 지수는 비어 있습니다. 검증된 시스템 결과가 하나도 게시되지 않았으므로, 이 사이트의 어떤 수치도 특정 제품의 성능을 설명하지 않습니다.",
    noResultsHeadline: "아직 게시된 검증 시스템 결과가 없습니다.",
    noResultsDetail:
      "MICA는 어떤 시스템도, 어떤 점수도, 어떤 순위도 게시하지 않았습니다. 지금 존재하는 것은 장치입니다. 시장별로 따로 작성한 10개 계열의 과제 분류 체계, 공개된 측정 방법, 기준값이 아직 설정되지 않은 게재 관문, 그리고 앞으로의 모든 수치가 이름 붙은 집계 실행 셀로 환원되는 증거 모델입니다. 제출된 스냅숏이 독립적으로 재실행되고 이 관문을 통과한 뒤에야 결과가 이곳에 나타납니다.",
    ...
    readinessIntro:
      "MICA는 공개된 상태로 만들어지고 있으므로, 각 부분의 상태를 빈 표로 암시하지 않고 그대로 밝힙니다. 아래의 어떤 항목도 측정 결과가 아닙니다.",
    readinessItems: [
      {
        term: "과제 분류 체계",
        detail:
          "일상 과제 10개 계열이며, 다섯 시장 에디션마다 따로 작성했습니다. 정본 과제마다 선언된 최종 상태와 확인 경계가 있습니다. 완성되어 공개되었습니다.",
      },
      {
        term: "측정 방법",
        detail:
          "정확도·속도·비용을 세 개의 별도 결과로 정의하고, 유효성 선별과 성공 실행만을 대상으로 한 백분위수, 통화별 비용을 규정합니다. 초안으로 공개되어 있으며 반론을 받습니다.",
      },
      {
        term: "증거 인프라",
        detail:
          "증거의 단위는 집계 실행 셀이며, 주소를 가지고 전문이 공개되고 무엇을 보여 줄 수 없는지까지 밝힙니다. 구축되었고 비어 있습니다. 기록된 셀이 없습니다.",
      },
      {
        term: "게재 관문",
        detail:
          "독립 재실행, 커버리지, 안전 조건이 이미 적용되고 있으며 수치 기준값은 의도적으로 아직 정하지 않았습니다. 오늘은 어떤 결과도 관문을 통과할 수 없고, 그래서 게시된 것이 없습니다.",
      },
      {
        term: "검증된 결과",
        detail:
          "없습니다. 측정된 제출물이 없고, 재실행된 스냅숏이 없으며, 어떤 시장이나 과제 계열에도 순위가 존재하지 않습니다.",
      },
    ],
  ...
  countries: {
    ...
    coverageTitle: "다섯 에디션 한눈에 보기",
    coverageIntro:
      "각 시장의 로캘, 통화, 그리고 그 시장을 위해 작성한 히어로 미션 수입니다. 어떤 시장에서도 측정된 시스템이 없으므로 결과 열은 존재하지 않습니다.",
  ...
  rankings: {
    ...
    standfirst:
      "게시된 검증 결과가 없으므로 이 페이지는 오늘 아무것도 정렬하지 않습니다. 아래 컨트롤은 방법론을 눈에 보이게 만든 것입니다. 시장을 먼저 고르고 과제 계열, 결과 축, 검증 수준을 고르는 순서입니다. 수치가 하나도 나오기 전에 앞으로의 표가 어떤 모양일지 확인하고 반론할 수 있도록 미리 보여 줍니다.",
    filterEyebrow: "계획된 컨트롤",
    ...
    orderedBy: "정렬 기준",
    noResultsNotice:
      "이 구간에도, 다른 어떤 구간에도 게시된 검증 결과가 없습니다. MICA는 아직 어떤 시스템도 측정하지 않았으므로 표도 없고 연결할 증거도 없습니다. 제출된 스냅숏이 독립적으로 재실행되어 게재 관문을 통과하는 대로 이 페이지가 시장 단위로 채워집니다.",
  },
  ...
  agents: {
    ...
    emptyNotice:
      "제출·검증·게시된 시스템 스냅숏이 하나도 없습니다. 예시 항목으로 이 페이지를 채우는 대신 MICA는 비워 둡니다. 그럴듯한 이름 옆에 그럴듯한 수치를 놓는 것이야말로 벤치마크가 막으려는 실패이기 때문입니다. 아래 라벨은 첫 항목이 등록될 때 그 항목이 무엇을 담게 되는지 정의합니다.",
  ...
  evidence: {
    ...
    standingTerm: "지위",
    standingDetail:
      "기록된 셀이 없습니다. 그와 무관하게 게재 가드는 계속 작동합니다. 지수가 프리뷰 상태인 동안에는 어떤 것도 게재 대상으로 표시될 수 없습니다.",
    filterEyebrow: "필터",
    filterTitle: "셀 찾기",
    filterIntro:
