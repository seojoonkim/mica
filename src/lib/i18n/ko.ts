...
export const ko = {
  ...
  site: {
    ...
    definition:
      "MICA는 버전을 고정한 완성 상태의 소비자 에이전트 시스템을 아시아 5개 시장의 일상 과제로 측정합니다. 정확도·속도·비용은 하나로 합치지 않고 세 가지 결과로 따로 보고합니다.",
    edition: "프리뷰 에디션 0.1",
    ...
    readinessItems: [
      {
        term: "과제 분류 체계",
        detail:
          "일상 과제 10개 계열이며, 다섯 시장 에디션마다 따로 작성했습니다. 표준 과제마다 선언된 최종 상태와 확인 경계가 있습니다. 완성해 공개했습니다.",
      },
      {
        term: "측정 방법",
        detail:
  ...
  countries: {
    ...
    standfirst:
      "MICA는 한 시장의 벤치마크를 나머지 넷으로 번역하지 않습니다. 각 에디션은 그 나라에 실제로 존재하는 결제 인프라, 신원 확인, 주소 형식, 서비스 관행에 맞춰 따로 작성합니다.",
  ...
  notFound: {
    ...
    body: "MICA는 한국·일본·싱가포르·대만·태국의 다섯 시장과 정해진 시스템 스냅샷 집합을 다룹니다. 그 목록 밖의 것은 빈 페이지가 아니라 아예 페이지가 없습니다.",
  },
