...
export const ko = {
  ...
  site: {
    ...
    definition:
      "MICA는 버전을 고정한 완성 상태의 소비자 에이전트 시스템을 아시아와 중동 6개 시장의 일상 과제로 측정합니다. 검증된 과제는 정규화된 정확도·속도·비용 성분을 곱해 하나의 최종 점수를 받으며, 세 축의 원값은 그 옆에 따로 공개됩니다.",
    edition: "프리뷰 에디션 0.1",
    demoNotice:
  ...
  submit: {
    ...
    traceTerm: "근거 추적",
    traceDetail:
      "실행별 기록: 유효성, 실제 경과 시간, USD 기준 평가 실행 비용, 도달한 최종 상태, 시스템이 확인을 위해 멈춘 모든 지점, 그리고 공급자·모델·버전·목적·토큰·비용·지연·순서를 포함한 모든 모델 호출.",
    stepTwoEyebrow: "2단계",
