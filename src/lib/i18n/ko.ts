...
export const ko = {
  ...
  site: {
    ...
    tagline: "소비자 에이전트 오케스트레이션을 재는 국제 벤치마크.",
    secondary: "모델도 중요하다. 그러나 승부는 오케스트레이션에서 갈린다.",
    definition:
      "MICA는 완성된 버전 고정 소비자 에이전트 시스템을 아시아 5개 시장의 일상 과제로 측정하고, 정확도·속도·비용을 하나로 합치지 않고 세 개의 결과로 각각 보고합니다.",
    edition: "프리뷰 에디션 0.1",
    editionStrip: ["프리뷰", "방법론 초안", "5개 시장", "10개 과제 계열"],
    demoNotice:
  ...
  coverage: {
    headline: "평가 계열 10개 · 데모 결과가 채워진 계열 4개",
    detail:
      "MICA의 평가 분류 체계는 10개의 과제 계열을 정의합니다. 시드 데모 픽스처에는 그중 4개 계열의 결과만 들어 있습니다. 나머지 6개는 정의만 되어 있고 아직 측정되지 않았습니다. 이 사이트에 해당 계열의 점수는 존재하지 않으며, 없는 점수를 0으로 표시하지 않습니다.",
    evaluationFamiliesTerm: "평가 계열",
    seededFamiliesTerm: "데모 결과가 채워진 계열",
    measuredBadge: "데모 결과 있음",
    unmeasuredBadge: "정의됨, 아직 미측정",
    unmeasuredNote:
      "분류 체계에 정의되어 있으나, 이 계열에 대한 데모 실행 셀은 아직 없습니다.",
  },
  ...
  table: {
    ...
    frontier: "프런티어",
    editionNote: "에디션 노트",
    systemsCovered: "커버된 시스템",
    accuracySpread: "정확도 분포",
    highestAccuracy: "데모 내 최고 정확도",
    globalAccuracy: "전체 정확도",
    marketsCovered: "커버된 시장",
    heroMissions: "대표 미션",
    withheld: "보류 — 모든 시장을 커버하지 않음",
    notPublicationEligible: "게재 대상 아님",
    criticalSafetyEvent: " — 중대 안전 사건",
    costNotComparable: "통화가 달라 비교 불가",
    emptySlice:
      "데모 에디션의 어떤 시스템도 이 조건에 해당하는 실행 셀이 없습니다.",
    ...
    footnote:
      "정확도는 선언된 최종 상태에 도달한 유효 실행의 비율입니다. 속도 p50과 p95는 성공한 유효 실행만을 대상으로 하므로, 시도에 걸린 시간이 아니라 성공에 걸린 시간을 뜻합니다. 실패한 시도의 시간도 실행 셀에 함께 기록되지만 이 모집단에는 포함되지 않습니다. 비용은 모든 유효 시도의 비용을 성공 횟수로 나눈 값입니다. “프런티어”는 세 축 모두에서 열위에 있지 않은 행을 표시한 것으로, 순위가 아닙니다.",
  },
  ...
  home: {
    ...
    submitSnapshot: "시스템 스냅숏 제출",
    statMarkets: "시장",
    statFamilies: "과제 계열",
    statSeeded: "결과가 있는 계열",
    statSystems: "시스템 스냅숏",
    statRuns: "유효 실행",
    countedNote: "빌드 시점에 데모 픽스처에서 직접 센 값입니다.",
    disclosureDetail:
      "MICA는 아직 구축 중입니다. 아래 인터페이스는 완성되어 있지만, 그 뒤의 데이터는 인터페이스를 만들고 시험하기 위한 시드 합성 픽스처입니다. 여기 있는 어떤 내용도 실제 제품의 성능을 설명하지 않습니다.",
    axesEyebrow: "결과는 셋, 결코 하나가 아니다",
    axesTitle: "MICA는 정확도·속도·비용을 따로 보고합니다",
    axesIntro:
      "숫자 하나로 합치면 구매자가 실제로 감수해야 할 교환 관계가 가려집니다. MICA는 종합 점수를 발표하지 않으며 앞으로도 발표하지 않습니다. 아래 세 축은 나란히 읽습니다.",
    ledgerEyebrow: "실행 셀에서 산출",
    ledgerTitle: "시장별 원장",
    ledgerIntro:
      "모든 시장은 그 시장의 기준으로 평가됩니다. 어떤 시장에서 실행되지 않은 시스템은 0이 아니라 커버리지 없음으로 표시됩니다.",
    ledgerCaption: "시장별 데모 정확도 분포",
    globalEyebrow: "모든 시장에 동일한 가중치",
    globalTitle: "지수 전체 데모 정확도",
    globalIntro:
      "시스템마다 하나의 수치이며, 국가 매크로 평균으로 계산합니다. 즉 해당 시스템의 시장별 정확도의 평균입니다. 실행을 한데 모아 계산하지 않으므로 시도가 많은 시장이 더 큰 비중을 갖지 않습니다. 한 시장이라도 빠진 시스템에는 전체 수치가 아예 없습니다. 속도와 비용은 여기에 표시하지 않습니다. 그 둘은 하나의 시장과 하나의 통화에 속합니다.",
    globalCaption: "시스템별 전체 정확도, 국가 매크로 평균",
    globalCaptionSuffix:
      "예시용 데모 데이터이며 공식 순위가 아닙니다. MICA는 종합 점수를 발표하지 않습니다.",
    globalNote:
      "다섯 시장 중 하나라도 실행 셀이 없으면 국가 매크로 평균은 추정하지 않고 보류합니다.",
    filterLink: "시장·과제 계열·결과 축으로 걸러 보기 →",
  ...
  countries: {
    metaTitle: "국가",
    metaDescription:
      "MICA 지수가 다루는 5개 시장과, 각 시장에서 소비자 에이전트에게 달라지는 조건.",
    eyebrow: "시장 목록",
    title: "다섯 시장, 다섯 개의 서로 다른 문제",
    standfirst:
      "MICA는 한 시장의 벤치마크를 나머지 넷으로 번역하지 않습니다. 각 에디션은 그 나라에 실제로 존재하는 결제 인프라, 신원 확인, 주소 형식, 서비스 관행에 맞춰 작성됩니다.",
    coverageEyebrow: "실행 셀에서 산출",
    coverageTitle: "커버리지 한눈에 보기",
    coverageIntro:
      "커버된 시스템은 해당 시장에 데모 실행 셀이 하나 이상 있는 시스템의 수입니다.",
    coverageCaption: "시장 커버리지",
    highestAccuracy: "데모 최고 정확도",
    editionsEyebrow: "에디션",
    editionsTitle: "에디션 노트가 말하는 것",
    editionsIntro:
      "각 시장 에디션에는 그 나라에서 MICA가 범위를 어떻게 정했는지 설명하는 노트가 서명처럼 붙습니다.",
  },
  ...
  country: {
    ...
    familyIntro:
      "같은 시스템이라도 한 계열에서는 능숙하고 다른 계열에서는 끝내지 못할 수 있습니다. 계열별 셀을 따로 보여 주는 이유입니다.",
    ...
    lineageTitle: "실행 셀 —",
    lineageIntro:
      "각 셀은 이 시장에서 하나의 시스템이 하나의 과제 계열을 수행한 기록입니다. 위 표는 이 셀들로부터 계산되며, 셀 페이지는 각 집계가 담고 있는 것과 보여 줄 수 없는 것을 함께 밝힙니다.",
    allCellsFor: "다음 시장의 모든 실행 셀:",
    hazardsEyebrow: "운영상의 난점",
    hazardsTitlePrefix: "",
    hazardsTitleSuffix: "시장이 에이전트에게 어려운 이유",
    hazardsIntro:
      "각 난점은 그것이 걸리는 진단 축과 연결되어 있어, 실패를 막연한 난이도가 아니라 특정 역량으로 추적할 수 있습니다.",
  ...
  rankings: {
    ...
    standfirst:
      "먼저 시장을 고르고, 그다음 과제 계열과 관심 있는 축을 고르십시오. 기본값은 독립 재실행으로 검증된 시스템만 보여 줍니다. 검증 필터를 넓히면 잠정 결과나 자체 보고 결과도 볼 수 있습니다. 정렬은 바뀌어도 수치는 바뀌지 않습니다. MICA는 종합 점수를 발표하지 않으며, 정확도 1위인 시스템이 비용에서는 꼴찌일 수 있습니다.",
    filterEyebrow: "필터",
    filterTitle: "데모 픽스처 잘라 보기",
    filterIntro:
      "이 폼은 일반 링크처럼 전송되므로, 여기의 어떤 화면이든 북마크하거나 공유할 수 있습니다.",
    formLabel: "결과 필터",
    orderByAxis: "정렬 축",
    ...
    orderingBy: "정렬 기준:",
    costAcrossMarkets:
      "비용은 여러 시장을 한꺼번에 놓고 정렬할 수 없습니다. 다섯 에디션은 통화를 공유하지 않습니다. 성공당 비용을 보려면 시장을 하나만 선택하십시오.",
    ...
    orderedBy: "정렬 기준",
    pooledNotePrefix:
      "여기의 각 행은 모든 과제 계열을 합친 값이므로 뒤에 하나의 실행 셀이 있지 않습니다. 과제 계열을 하나만 고르면 실행 셀로 바로 연결되며, 아니면 다음을 둘러보십시오:",
    pooledNoteLink: "다음 시장의 실행 셀:",
  },

  agents: {
    metaTitle: "시스템",
    metaDescription:
      "MICA 데모 에디션에 포함된 버전 고정 소비자 에이전트 시스템 스냅숏.",
    eyebrow: "시스템 목록",
    title: "MICA는 모델이 아니라 시스템을 측정합니다",
    standfirst:
      "하나의 항목은 시스템 전체를 날짜와 함께 고정한 스냅숏입니다. 오케스트레이터, 모델, 도구, 메모리를 한 묶음으로 봅니다. 같은 기반 모델을 쓰는 두 항목이 멀리 떨어진 결과를 낼 수 있고, 그것이 바로 요점입니다.",
    snapshotsEyebrow: "실행 셀에서 산출",
    snapshotsTitle: "이 에디션의 스냅숏",
    snapshotsIntro:
      "전체 정확도는 국가 매크로 평균이며, 모든 시장에 셀이 있는 시스템에만 존재합니다. 한 시장이 빠진 시스템은 낮은 점수가 아니라 커버리지 없음으로 표시됩니다.",
    snapshotsCaption: "시스템 스냅숏",
    labelsEyebrow: "라벨 읽는 법",
    verificationTitle: "검증 상태",
    verificationIntro:
      "게재 트랙에 오를 수 있는 것은 독립 재실행 결과뿐입니다. 다만 데모 데이터는 어떤 경우에도 게재 대상이 될 수 없으므로, 이 데모 에디션의 모든 항목은 그와 무관하게 제외됩니다.",
    tracksTitle: "결과 트랙",
  },

  agent: {
    notFound: "해당 시스템을 찾을 수 없습니다",
    metaTitleSuffix: "시스템 스냅숏",
    eyebrowPrefix: "시스템 스냅숏",
    compositionEyebrow: "측정 대상",
    compositionTitle: "스냅숏 구성",
    compositionIntro:
      "MICA는 시스템 전체를 기록합니다. 이 구성의 어느 한 부분이라도 바뀌면 갱신이 아니라 새로운 스냅숏이 됩니다.",
    ...
    byFamilyIntro:
      "여러 시장을 합친 값이므로 비용은 보류합니다. 다섯 에디션은 통화를 공유하지 않습니다.",
    ...
    noCells: "이 스냅숏은 데모 에디션에 실행 셀이 없습니다.",
    ...
    gateEyebrow: "게재 관문",
    gateTitle: "여기의 어떤 것도 게재할 수 없는 이유",
    gateIntro:
      "MICA는 결과를 조용히 빼는 대신, 게재할 수 없는 이유를 밝힙니다.",
    readPublicationRules: "게재 규칙 읽기 →",
    otherSystems: "다른 시스템",
    otherSnapshots: "다른 스냅숏",
  },
  ...
  tasks: {
    ...
    taxonomyTitle: "정의된 계열 10개, 데모 결과가 채워진 계열 4개",
  ...
  evidence: {
    ...
    disclosureDetail:
      "이것은 데모 픽스처 셀이며 공식 근거가 아닙니다. 게재된 수치의 계보를 인터페이스에서 확인할 수 있도록 존재할 뿐, 어떠한 증거력도 없습니다.",
    modelEyebrow: "실행 셀이란",
    modelTitle: "근거 모델",
    modelIntro:
    ...
    unitTerm: "단위",
    unitDetail:
      "시스템 × 시장 × 과제 계열마다 하나의 집계 실행 셀. 셀 id는 system--market--family 형식이며, 예를 들어 atlas-concierge--kr--email-calendar입니다.",
    holdsTerm: "담고 있는 것",
    holdsDetail:
      "유효 실행 수와 성공 실행 수, 성공한 유효 실행의 지연 시간, 전체 유효 시도의 지연 시간 모집단, 총 유효 비용, 과제 커버리지, 중대 안전 사건.",
    ...
    standingTerm: "지위",
    standingDetail:
      "인터페이스 개발용 픽스처 근거입니다. 모든 셀은 dataStatus: demo이며 publicationEligible: false입니다.",
    filterEyebrow: "필터",
    filterTitle: "셀 찾기",
    filterIntro:
  ...
  evidenceCell: {
    ...
    cellId: "셀 id",
    dataStatus: "데이터 상태",
    publicationEligibility: "게재 가능 여부",
    eligible: "가능",
    notEligible: "게재 대상 아님 — 차단 사유는 아래에 있습니다.",
    unknown: "알 수 없음",
    measuredEyebrow: "측정값",
    measuredTitle: "이 셀이 기록하는 것",
    measuredIntro:
      "정확도·속도·비용은 따로 읽습니다. 속도 백분위수는 성공한 유효 실행만을 대상으로 하므로 빠른 실패가 빠른 성공으로 읽히지 않습니다. 보고된 분모를 감사할 수 있도록 전체 유효 시도 모집단을 그 옆에 함께 적습니다.",
    captionPrefix: "실행 셀",
    ...
    basisAllEligiblePrefix:
      "성공 여부와 무관하게 모든 유효 시도에 대해 기록한 지연 시간입니다 (중앙값",
    basisAllEligibleSuffix:
      "). 감사를 위해 보관하며, 위에 게재된 백분위수는 이 모집단에서 뽑은 것이 아닙니다.",
    ...
    basisCoverageSuffix: ").",
    basisSafetyRecorded: "기록됨 — 이 셀의 게재를 영구히 차단합니다.",
    basisSafetyNone: "이 셀에는 기록된 사건이 없습니다.",
    gateEyebrow: "게재 관문",
    gateTitle: "이 셀을 게재할 수 없는 이유",
  ...
  methodology: {
    metaTitle: "방법론",
    metaDescription:
      "MICA가 유효성을 어떻게 정의하고, 정확도·속도·비용을 어떻게 측정하며, 무엇을 게재할 수 있는지 어떻게 결정하는가.",
    eyebrow: "방법론 초안",
    ...
    speedTerm: "속도",
    countingSpeed:
      "는 성공한 유효 실행의 실제 경과 초만을 사용하며 p50과 p95로 보고합니다. 실패한 실행의 시간도 측정해 실행 셀에 보관하지만, 보고 백분위수에서는 의도적으로 제외합니다. 포함한다면 빨리 포기하는 시스템이 빠른 것으로 읽히기 때문입니다. 따라서 속도 수치의 모집단은 성공들이며, 정확도의 분모인 유효 실행보다 작습니다.",
    costTerm: "비용",
    countingCostPrefix:
    ...
    missingNotMeasured:
      "이 스냅숏에서 해당 축은 평가하지 않았습니다. 낮은 값이 아닙니다.",
    diagnosticsEyebrow: "진단",
    ...
    evidenceIntro:
      "모든 수치는 그것이 어떻게 얻어졌는지를 함께 지닙니다. 게재 트랙 위의 독립 재실행 결과만이 공식이 될 수 있습니다.",
    onPublicationTrack: "게재 트랙에 있습니다.",
    neverOfficial: "공식으로 게재되지 않습니다.",
    neverOfficialLong: "투명성을 위해 표시하며, 공식으로 게재되지 않습니다.",
    publicationEyebrow: "관문",
    publicationTitle: "게재 규칙",
    publicationIntro:
    ...
    safetyTerm: "중대 안전 사건",
    safetyBlocks:
      "중대 안전 사건이 하나라도 있으면 해당 셀의 게재를 영구히 차단합니다. 이의 제기도, 이를 지우기 위한 재실행도 없습니다.",
    safetyNonBlocking: "기록하되 차단하지 않습니다.",
    verificationTerm: "검증",
    verificationDetail:
      "독립 재실행만 인정합니다. 잠정 결과와 자체 보고 결과는 투명성을 위해 표시되며 공식으로 게재되지 않습니다.",
    dataStatusTerm: "데이터 상태",
    dataStatusDetail:
      "데모와 프리뷰 데이터는 어떤 경우에도 게재 대상이 될 수 없습니다. 이는 스키마 계층에서 강제되며, 데모 레코드가 그렇지 않다고 주장하면 빌드 시점에 오류를 냅니다.",
    claimsEyebrow: "주장",
    ...
    limits: [
      ...
      "비용은 스냅숏 날짜의 운영 주체 가격 정책에 좌우되며, 시스템의 행동과 무관하게 움직입니다.",
      "커버리지는 시장마다 고르지 않으며, 커버되지 않은 시장은 추정하지 않고 없음으로 보고합니다.",
      "10개 평가 계열 중 6개에는 시드 데모 결과가 전혀 없으므로, 이 사이트의 어떤 내용도 그 계열들을 설명하지 않습니다.",
    ],
  ...
  governance: {
    ...
    operatorDetail:
      "제출자는 자기 스냅숏 구성에 관한 사실을 정정할 수 있습니다. 검증 상태, 게재 가능 여부, 해석에 대해서는 발언권이 없습니다.",
    conflictsTerm: "이해충돌",
    conflictsDetail:
    ...
    corrections: [
      ...
      "정정은 원래 값, 정정된 값, 날짜, 사유와 함께 공개됩니다. 게재된 수치를 조용히 고치는 일은 거버넌스 실패로 취급합니다.",
  ...
  submit: {
    metaTitle: "시스템 제출",
    metaDescription:
      "MICA가 소비자 에이전트 시스템 스냅숏을 측정하기 위해 필요한 것과, 제출물을 어떻게 다루는가.",
    eyebrow: "제출",
    title: "시스템 스냅숏 제출",
    standfirst:
      "MICA는 날짜와 버전이 고정된 시스템을 측정합니다. 오케스트레이터, 모델, 도구, 메모리를 한 묶음으로 봅니다. 제출은 무료이며, 결과에 어떤 영향력도 주지 않고, 스스로 책임질 수 있는 스냅숏에서 시작합니다.",
    disclosureDetail:
      "MICA는 아직 공식 에디션을 위한 제출을 받지 않습니다. 아래 요건은 실제 요건이며, 현재 이 사이트의 결과는 예시용 데모 데이터이고 공식 순위가 아닙니다.",
    stepOneEyebrow: "1단계",
    stepOneTitle: "스냅숏 선언",
    stepOneIntro:
      "스냅숏은 변경할 수 없습니다. 어느 부분이라도 바꾸면 갱신이 아니라 새 스냅숏이 됩니다.",
    identityTerm: "식별 정보",
    identityDetail:
      "시스템 이름, 운영 주체, 스냅숏 버전 문자열, 스냅숏 날짜.",
    compositionTerm: "구성",
    compositionDetail:
    ...
    sampleSizeUnset:
      "아직 미정. MICA는 무엇이든 게재하기 전에 국가 × 계열 셀당 최소 유효 실행 수를 명시할 것입니다.",
    sampleSizePrefix: "최소",
    sampleSizeSuffix: "회의 유효 실행(국가 × 계열 셀당).",
    coverageTerm: "커버리지",
    coverageUnset:
      "아직 미정. MICA는 무엇이든 게재하기 전에 제출물이 시도해야 하는 시장 표준 과제의 비율을 명시할 것입니다.",
    coveragePrefix: "최소",
    ...
    terms: [
      "스냅숏 구성의 사실 오류는 언제든 정정할 수 있습니다.",
      "결과가 공개되기 전에 열람하거나, 공개를 미루거나, 거부할 수 없습니다.",
      "노출 위치, 포함 여부, 유리한 발표 시점을 돈으로 살 수 없습니다. 유료 등급은 존재하지 않습니다.",
      "귀하의 셀이 게재 관문을 통과하지 못하면 그 차단 사유를 공개되는 문구 그대로 통지받습니다.",
      "이후 에디션에서 스냅숏을 철회할 수 있습니다. 이미 게재된 수치는 철회 사실이 표기된 채 그대로 남습니다.",
    ],
    contactEyebrow: "연락",
  ...
  notFound: {
    ...
    body: "MICA는 한국·일본·싱가포르·대만·태국의 다섯 시장과 정해진 시스템 스냅숏 집합을 다룹니다. 그 목록 밖의 것은 빈 페이지가 아니라 아예 페이지가 없습니다.",
  },
  ...
  verification: {
    "independent-rerun": {
      ...
      short: "IND",
      description:
        "MICA가 제출된 시스템 스냅숏을 MICA 통제 계정과 인프라에서 직접 다시 실행했고, 전체 근거 추적을 보유합니다.",
    },
    provisional: {
      label: "잠정",
      short: "PROV",
      description:
        "MICA가 부분 실행이나 감독 하의 실행을 관찰했거나, 주장된 커버리지의 일부에 대해서만 근거를 보유합니다. 보고는 하되 공식으로 게재하지 않습니다.",
    },
    "self-reported": {
      label: "자체 보고",
      short: "SELF",
  ...
  thresholdsNotSet:
    "이 에디션에는 게재 임계값이 설정되어 있지 않습니다. MICA가 최소 표본 크기나 과제 커버리지를 아직 합의하지 않았으므로, 어떤 결과도 게재 대상으로 표시될 수 없습니다.",
} satisfies Dict;
