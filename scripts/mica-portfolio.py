    ...
    ready = {
        ...
        "guidanceKo": {
            ...
            "category": (
                ...
                "경계 지침: 분쟁조정·피해구제·상담·신고 같은 공적 구제 절차는 경로이지 영역이 아니다. 절차가 끝났을 때 바뀌어 있는 외부 상태가 "
                "귀속되는 생활 계약·계정·거래로 판정한다. 결과가 특정 생활 계약의 상태를 바꾸면(환불·정산·명의·예약·요금·반환) 그 생활 영역이고, "
                "바꾸지 않으면(일반적 손해배상, 정보 취득, 접수 확인 자체) 소재 영역이 아니라 government-civic 해당 여부와 상태 변화 과업 요건을 재검토한다. "
